...
export const GET_CLASSES = 'https://demoapi.nortify.com.ng/api/ClassArm/GetAll';
export const GET_ACADEMIC_SESSION = 'https://demoapi.nortify.com.ng/api/AcademicSession/GetAll';
