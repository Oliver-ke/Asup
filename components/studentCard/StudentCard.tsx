...
const Card: FC<StudentCardProp> = ({ student }): ReactElement => {
	const { LastName, FirstName, AdmissionDate, status, Gender, GuardianAddress, ImageData } = student;
	return (
		<TouchableOpacity style={styles.card}>
			<View style={styles.cardImg}>
				<Image style={{ width: 60, height: 60, resizeMode: 'cover' }} source={ImageData} />
			</View>
